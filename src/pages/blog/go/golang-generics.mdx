...
description: In Go 1.18 generics were introduced, which enables us to write generic functions and types. In this article, we will learn about generics in Go.
...
Generics allow types to be parameterized over types or values.
