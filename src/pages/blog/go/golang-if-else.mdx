...
image: /images/golang-if-else.avif
imageDescription:
keywords:
  - golang if else
  - If Else Golang
...
## What is an If-Else Statement? <SectionLink id="what-is-an-if-else-statement" />
...
## If-Else Conditions in Golang <SectionLink id="if-else-conditions-in-golang" />
...
## Nested If-Else Statements in Golang <SectionLink id="nested-if-else-statements-in-golang" />
...
## Else If Statements in Golang <SectionLink id="else-if-statements-in-golang" />
