...
This has the drawback that it cannot be assumed that the counter will be increased by 100. This occurs as a result of numerous goroutines simultaneously accessing the counter. The operating system refers to this phenomenon as a **data race** when multiple users simultaneously access the same memory address. Atomic operations are useful in this situation.
