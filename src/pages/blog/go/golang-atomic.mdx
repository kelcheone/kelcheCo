...
<Link url="https:kelche.co">Back to Home</Link>

## What is Atomic? <SectionLink id="what-is-atomic" />

In Golang, atomic is a package that provides low-level atomic memory primitives useful for implementing synchronization algorithms. Atomic operations execute in constant time and are implemented in assembly language on supported platforms. They are provided for int32, int64, uint32, uint64, uintptr, unsafe.Pointer, and unsafe.Size values.

## Atomic Counter <SectionLink id="atomic-counter" />
...
## Atomic functions <SectionLink id="atomic-functions" />
...
### Load and Store <SectionLink id="load-and-store" />
...
### CompareAndSwap <SectionLink id="compareandswap" />
...
### LoadPointer and StorePointer <SectionLink id="loadpointer-and-storepointer" />
...
### SwapPointer <SectionLink id="swappointer" />
...
### CompareAndSwapPointer <SectionLink id="compareandswappointer" />
