...
## How to define a byte in Go. <SectionLink client:load id="how-to-define-a-byte-in-go" />
...
## Bytes array or slice <SectionLink client:load id="bytes-array-slice" />
...
## Bytes and strings <SectionLink client:load id="bytes-and-strings" />
...
## Bytes and runes <SectionLink client:load id="bytes-and-runes" />
...
## Byte manipulation with the `bytes` package <SectionLink client:load id="byte-manipulation-with-the-bytes-package" />
