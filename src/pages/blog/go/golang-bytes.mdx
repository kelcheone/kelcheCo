...
author: Kevin Kelche
title: Golang Bytes
description: A byte is an unsigned integer that represents a single byte of data it is represented by the `uint8` type. By convention a byte is represented by the `byte` keyword. A byte is 1 byte long.
date: 20 January 2023
image: https://images.unsplash.com/photo-1674027172047-7658c0305727?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80
imageDescription: Golang bytes
imageSource: Unsplash
imageUrl: https://unsplash.com/photos/QG_PJY-7M6g
keywords:
  - Go bytes
tags:
  - golang
...
A byte is an unsigned integer that represents a single byte of data it is represented by the `uint8` type. By convention a byte is represented by the `byte` keyword. A byte is 1 byte long.
