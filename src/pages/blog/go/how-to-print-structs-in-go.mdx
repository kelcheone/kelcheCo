...
# How to print structs in Go <SectionLink client:load  id= "how-to-print-structs-in-go" />
...
## How to print a nested struct in Go <SectionLink client:load  id= "how-to-print-a-nested-struct-in-go" />
...
## How to print a struct with a slice in Go <SectionLink client:load  id= "how-to-print-a-struct-with-a-slice-in-go" />
