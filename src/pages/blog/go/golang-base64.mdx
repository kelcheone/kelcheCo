...
## Base64 Encoding in Go <SectionLink id="base64-encoding-in-go" />
...
## Base64 Decoding in Go <SectionLink id="base64-decoding-in-go" />
...
## Url Encoding and Decoding <SectionLink id="url-encoding-and-decoding" />
...
## Raw Encoding and Decoding <SectionLink id="raw-encoding-and-decoding" />
...
## Example: Encoding and Decoding a JSON Object <SectionLink id="example-encoding-and-decoding-a-json-object" />
...
## Other Functions in the Base64 Package <SectionLink id="other-functions-in-the-base64-package" />
...
- `RawURLEncoding` - returns the standard raw, unpadded base64 encoding, but with - an \_ substituted for + and / in the encoding alphabet.
- `RawStdEncoding` - returns the standard raw, unpadded base64 encoding.
- `StdEncoding` - returns the standard base64 encoding with padding as defined in RFC 4648.
- `URLEncoding` - returns the standard base64 encoding with padding, but with - and \_ substituted for + and / in the encoding alphabet.

## Other Types in the Base64 Package <SectionLink id="other-types-in-the-base64-package" />
