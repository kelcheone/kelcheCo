...
image: /images/golang-assert.avif
...
## What is Assert in Golang? <SectionLink client:load id = "what-is-assert-in-golang" />
...
## How to use Assert in Golang <SectionLink client:load id = "how-to-use-assert-in-golang" />
...
## Major Assert Methods <SectionLink client:load id = "major-assert-methods" />

### 1. Equal and NotEqual <SectionLink client:load id = "equal-and-notequal" />
...
### 3. Nil and NotNil <SectionLink client:load id = "nil-and-notnil" />
...
### 5. True and False <SectionLink client:load id = "true-and-false" />
...
### 6. Empty and NotEmpty <SectionLink client:load id = "empty-and-notempty" />
...
### 7. Len <SectionLink client:load id = "len" />
...
### 8. Contains <SectionLink client:load id = "contains" />
...
### 9. Panics and NotPanics <SectionLink client:load id = "panics-and-notpanics" />
...
### 10. Error and NoError <SectionLink client:load id = "error-and-noerror" />
