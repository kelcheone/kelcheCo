...
author: Kevin Kelche
title: Golang Assert
description: Assert is a package that provides a set of helper functions that make it easier to test various properties in your Go programs. It is intended to be used in the xtest files of your package, as an aid in writing tests.
date: 17 January 2023
image: https://images.unsplash.com/photo-1663289236123-5826e22f1064?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80
imageDescription: Golang Assert
imageSource: Unsplash
imageUrl: https://unsplash.com/photos/IOdCBWHWhfY
keywords:
  - Go Assert
  - Golang Assert
tags:
