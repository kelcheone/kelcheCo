...
description: Arrays in Go are a fixed-length sequence of elements of a single type. In this article, we will learn about arrays in Go.
date: 16 January 2023
image: /images/golang-arrays.avif
...
## What is an Array in Go? <SectionLink client:load id="what-is-an-array-in-go" />
...
## Creating an Array in Go <SectionLink client:load id="creating-an-array-in-go" />
...
## Accessing Array Elements in Golang <SectionLink client:load id="accessing-array-elements-in-golang" />
...
## Iterating Over an Array in Golang <SectionLink client:load id="iterating-over-an-array-in-golang" />
...
## Array Length in Golang <SectionLink client:load id="array-length-in-golang" />
...
## Array Slicing in Golang <SectionLink client:load id="array-slicing-in-golang" />
...
## Array Comparison in Golang <SectionLink client:load id="array-comparison-in-golang" />
...
## Array Sorting in Golang <SectionLink client:load id="array-sorting-in-golang" />
...
## Array Copy in Golang <SectionLink client:load id="array-copy-in-golang" />
...
## Array Delete in Golang <SectionLink client:load id="array-delete-in-golang" />
...
## Array Contains in Golang <SectionLink client:load id="array-contains-in-golang" />
...
## Array Reverse in Golang <SectionLink client:load id="array-reverse-in-golang" />
...
## Multidimensional Arrays in Golang <SectionLink client:load id="multidimensional-arrays-in-golang" />
...
### 2D Array in Golang <SectionLink client:load id="2d-array-in-golang" />
...
### Accessing 2D Array Elements in Golang <SectionLink client:load id="accessing-2d-array-elements-in-golang" />
...
### 2D Array Length in Golang <SectionLink client:load id="2d-array-length-in-golang" />
...
## Array of Slices in Golang <SectionLink client:load id="array-of-slices-in-golang" />
...
## Array of Maps in Golang <SectionLink client:load id="array-of-maps-in-golang" />
...
## Array of Functions in Golang <SectionLink client:load id="array-of-functions-in-golang" />
...
## Array of Interfaces in Golang <SectionLink client:load id="array-of-interfaces-in-golang" />
...
## Array of Pointers in Golang <SectionLink client:load id="array-of-pointers-in-golang" />
...
## Array of Channels in Golang <SectionLink client:load id="array-of-channels-in-golang" />
...
## Array of Structs in Golang <SectionLink client:load id="array-of-structs-in-golang" />
