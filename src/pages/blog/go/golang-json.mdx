...
author: Kevin Kelche
title: "Getting Started with JSON Parsing in Golang: A Comprehensive Guide"
description: "Learn how to parse JSON in Golang. This article covers the basics of JSON encoding and decoding, as well as how to use the json package to parse JSON."
date: 30 January 2023
image: /images/golang-json.avif
imageDescription:
keywords:
  - golang json
