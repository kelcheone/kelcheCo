...
## What is Buffered I/O? <SectionLink id="what-is-buffered-io" />
...
## How to Use Bufio <SectionLink id="how-to-use-bufio" />
...
### Creating a Buffered Reader <SectionLink id="creating-a-buffered-reader" />
...
## Reading from a Buffered Reader <SectionLink id="reading-from-a-buffered-reader" />
...
### Creating a Buffered Writer <SectionLink id="creating-a-buffered-writer" />
...
### Writing to a Buffered Writer <SectionLink id="writing-to-a-buffered-writer" />
...
## Change the Buffer Size <SectionLink id="change-the-buffer-size" />
...
## Bufio vs. I/O <SectionLink id="bufio-vs-io" />
...
## Other Bufio Functions <SectionLink id="other-bufio-functions" />
...
## Other Bufio Types <SectionLink id="other-bufio-types"/>
