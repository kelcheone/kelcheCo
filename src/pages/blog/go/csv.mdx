...
description: "In this article, we explore how to read and write CSV files in Go. We'll look at how to read and write CSV files in Golang, and how to use the built-in CSV package."
date: 16 March 2023
