...
author: Kevin Kelche
title: "A Simple Guide to Working with CSV Files in Golang"
description: "In this article, we delve into how to read and write CSV files in Go. We'll look at how to read and write CSV files in Golang, and how to use the built-in CSV package."
date: 16 March 2023
image: /images/golang-csv.avif
imageDescription:
keywords:
  - golang csv
  - golang csv reader
