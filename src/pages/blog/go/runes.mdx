...
A rune can also be initialized with a Unicode code point. A Unicode code point is a number that represents a character in the Unicode standard. To initialize a rune with a Unicode code point, we can use the `rune()` function.
